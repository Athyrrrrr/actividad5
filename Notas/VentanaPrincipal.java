...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    private void inicio() {
        ...
        calcular.addActionListener(this); // Agrega un ActionListener para gestionar eventos

        // Establece el botón Limpiar
        limpiar = new JButton("Limpiar");
        limpiar.setBounds(125, 170, 80, 23);
        limpiar.addActionListener(this); // Agrega un ActionListener para gestionar eventos
